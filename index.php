...
<body>
              ...
              <div>
               ...
               <div class="butzap">
                <i class="fa fa-laptop"></i>
                    <a type="button" href="#popup" class="butwr">Записаться на консультацию</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <form action="" method="post">
        <div id="popup" class="popup">
            <div class="popup_body">
                <div class="popup_content">
                    ...
                    <div class="popup_form">
                        <p class="lbl"><b style="color:red">*</b> Имя</p>
                        <input id="name" type="text" name="name" value="<?=htmlspecialchars($_POST["name"])?>" placeholder="Укажите имя" required>
                        <?php if($meserr){
                            echo ' <p class = "primech">'.$meserr . '</p>';}
                        ?> 

                        <p class="lbl"><b style="color:red">*</b> Телефон</p>
                        <input id="phone" type="text" name="phone" value="<?=htmlspecialchars($_POST["phone"])?>" placeholder="+7 (___) ___-__-__" required>
                        ...
                        <p class="d-flex flex-row" style="width: 98%;">
                        <input type="date" name="dateCall" value="<?=htmlspecialchars($_POST["dateCall"])?>" placeholder="Укажите дату" style="width: 50%; margin-right: 50px;">
                        <select name="timeCall" style="width: 50%;">
          ...
          <script src="templates/jquery.maskedinput.min.js"></script>
          <script>
